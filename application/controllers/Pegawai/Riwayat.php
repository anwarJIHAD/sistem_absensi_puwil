...
class Riwayat extends CI_Controller
{
    ...
    {
        $data['absen'] = $this->Absensi_model->getByIdj1($this->session->userdata('id_pegawai'));

        $data['judul'] = "Halaman Riwayat Absensi";
        $this->load->view('pegawai/header');
        $this->load->view('pegawai/riwayat/vw_pegawai', $data);
