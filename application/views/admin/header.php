    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
             ...
             <li class="nav-item active">
                <a class="nav-link" href="<?= site_url('Admin/JadwalAbsensi'); ?>">
                    <i class="fa fa-calendar"></i>
                    <span>Jadwal Absensi</span></a>
            </li>
            <li class="nav-item active">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= site_url('admin/cuti/terima'); ?>">Diterima</a>
                        <a class="collapse-item" href="<?= site_url('admin/cuti/tolak'); ?>">Ditolak</a>
                        <a class="collapse-item" href="<?= site_url('admin/cuti/belum_diverifikasi'); ?>">Belum diverifikasi</a>
