                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input name="tgl_mulai_cuti" type="date" value="<?= $cuti['tgl_mulai_cuti']; ?>"
                                class="form-control" id="tgl_mulai_cuti"
                        ...
                        <div class="form-group">
                            ...
                            <input name="tgl_selesai_cuti" type="date" value="<?= $cuti['tgl_selesai_cuti']; ?>"
                                class="form-control" id="tgl_selesai_cuti"
                                placeholder="masukkan tanggal selesai cuti anda..">
                        ...
                        <div class="form-group">
                            ...
                            <input name="alasan_cuti" type="Text" value="<?= $cuti['alasan_cuti']; ?>"
