...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="<?= site_url('pegawai/pegawai'); ?>">Pengajuan Cuti</a>
        </li>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input name="username" type="Text" value="<?= $pegawai['username']; ?>"
                                class="form-control" id="username" placeholder="Masukkan username anda...">
